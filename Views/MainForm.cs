...
namespace envio_correos_batch.Views
{
    public partial class MainForm : Form
    {
        ...
        private void SaveNewConfiguration(DataModel dataModel)
        {
            ...
            {
                LogEvent("No se pudo guardar la configuración, la siguiente vez que inicie el programa deberá volver a realizar la configuración");
        ...
        private void MainForm_Load(object sender, EventArgs e)
        {
            ...
            {
                _dataModel = new DataModel();
                LogEvent("Sin configuración previa");
            }
            else
            {
                _dataModel = configFile;
                LogEvent("Configuración previa cargada");
            }
